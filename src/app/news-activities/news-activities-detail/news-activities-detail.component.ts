...
export class NewsActivitiesDetailComponent implements OnInit {
  ...
  customOptions: OwlOptions = {
    ...
    dots: true,
    navSpeed: 100,
    navText: ['<img src="assets/images/icon-back.svg" alt="image-news-detail">', '<img src="assets/images/icon-next.svg" alt="image-news-detail">'],
    responsive: {
      0: {
        items: 1,
      }
  ...
  ngOnInit(): void {
    ...
    this.route.paramMap.subscribe((params: ParamMap) => {
      ...
      this.service.findNewsById(this.news_id).subscribe((res: any) => {
        ...
        // console.log("=" + res.data.gallery.length);
  ...
  next(){
    ...
    this.currentLightboxImage = this.dataNewsDetail.gallery[this.currentIndex].image
  }
